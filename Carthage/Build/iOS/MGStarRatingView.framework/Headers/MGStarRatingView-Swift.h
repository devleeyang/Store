...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MGStarRatingView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16MGStarRatingView14StarRatingView")
...
@property (nonatomic, strong) UIImage * _Nullable fillImage;
